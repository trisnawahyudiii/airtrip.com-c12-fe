...
const NavItem = ({
  ...
  return (
    <>
      <Link href={hrefLink}>
        <span
          className="inline-flex items-center justify-between py-1 hover:text-gray-400 hover:bg-gray-700 focus:text-gray-400 focus:bg-gray-700 rounded-lg px-1 cursor-pointer relative group"
